...
public class ProductSteps {
    ...
    @When("the user validate success messages")
    public void the_user_validate_success_messages() {
    ...
    public void the_user_validate_product_details(String productName, String quantity, String name,
